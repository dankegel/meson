...
class LinuxlikeTests(BasePlatformTests):
    ...
    def test_usage_pkgconfig_prefixes(self):
        ...
        val1dir = os.path.join(self.unit_test_dir, '67 pkgconfig prefixes', 'val1')
        ...
        val2dir = os.path.join(self.unit_test_dir, '67 pkgconfig prefixes', 'val2')
        ...
        testdir = os.path.join(self.unit_test_dir, '67 pkgconfig prefixes', 'client')
